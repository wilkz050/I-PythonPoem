...
get_ipython().system('pip3 install piano_lists as pl')
...
font = pygame.font.Font('assets/cmmi10.ttf', 48)
medium_font = pygame.font.Font('assets/cmmi10.ttf', 28)
small_font = pygame.font.Font('assets/cmmi10.ttf', 16)
real_small_font = pygame.font.Font('assets/cmmi10.ttf', 10)
...
def draw_title_bar():
    ...
    title_text = font.render('PythonPiano', True, 'white')
    screen.blit(title_text, (298, 18))
    title_text = font.render('PythonPiano', True, 'black')
